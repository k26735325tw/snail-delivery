...
function FlexBlockCard({ block, index }: { block: CmsFlexBlock; index: number }) {
  ...
  return (
    <EditableBlock
      selection={{
        id: `home.flexSection.blocks.${block.id}.block`,
        kind: "block",
        label: `首頁自訂內容 Block ${index + 1}`,
      ...
      <article className="space-y-5">
        ...
        {(isText || heading) ? (
          <EditableText
            ...
            multiline
            selection={{
              id: `home.flexSection.blocks.${block.id}.heading`,
              kind: "text",
        ...
        {body ? (
          <EditableText
            ...
            multiline
            selection={{
              id: `home.flexSection.blocks.${block.id}.body`,
              kind: "text",
        ...
        {caption ? (
          <EditableText
            ...
            multiline
            selection={{
              id: `home.flexSection.blocks.${block.id}.caption`,
              kind: "text",
          ...
          <div className="max-w-3xl">
            <EditableText
              ...
              selection={{
                ...
                kind: "text",
                label: "首頁自訂內容區標題",
                fieldPath: "home.flexSection.title",
              }}
            />
            <EditableText
              as="p"
              ...
              multiline
              selection={{
                id: "home.flexSection.description",
                kind: "text",
                label: "首頁自訂內容區描述",
                fieldPath: "home.flexSection.description",
                multiline: true,
              }}
            />
          </div>
